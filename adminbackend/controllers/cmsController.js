    ...
    plans: [
      {
        ...
        highlighted: false,
        cta: { label: 'Start 1 Month', href: '#contact' },
      },
      {
        id: 'p2',
        name: '3 Months',
        ...
        highlighted: true,
        cta: { label: 'Choose 3 Months', href: '#contact' },
      },
      {
        id: 'p3',
        name: '6 Months',
        ...
        highlighted: false,
        cta: { label: 'Choose 6 Months', href: '#contact' },
      },
      {
        id: 'p4',
        name: '12 Months',
        ...
        highlighted: false,
        cta: { label: 'Choose 12 Months', href: '#contact' },
      },
    ],
  },
  contact: {
...
export const getCMSContent = async (req, res, next) => {
  try {
    const content = await CMSContent.findOne({ key: 'gymData', isActive: true });
...
export const updateCMSContent = async (req, res, next) => {
  try {
    ...
    let content = await CMSContent.findOne({ key: 'gymData' });
    ...
    if (content) {
      ...
      content = await CMSContent.create({
        ...
        description: 'Main gym site content structure',
